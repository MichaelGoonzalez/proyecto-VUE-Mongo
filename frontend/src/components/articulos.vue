<template>
    <div id="contenedor" class="container">
                    ...
                    <ul class="nav nav-tabs nav-tabsp nav-fill" id="productos" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="todos-tab" data-bs-toggle="tab" data-bs-target="#todos"
                                type="button" role="tab" aria-controls="todos" aria-selected="true" :@click="res">Todos</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown-categorias">
                                <li><a class="dropdown-item text-white" href="#" aria-controls="consejos" aria-selected="true">Consejos</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="res" role="tabpanel" aria-labelledby="todos-tab">
                    <section class="row">
                        <div v-for = "item in Array" :key= "item.id" class="col-12 col-lg-4 mt-5">
